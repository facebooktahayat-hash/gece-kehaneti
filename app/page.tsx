...
export default function HomePage() {
  return (
    <>
      <section className="relative min-h-[780px] overflow-hidden px-4 pb-16 pt-0 md:px-6">
        <HeroEffects />

        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-5xl px-5 pt-[126px] text-center md:pt-[150px]">
            ...
            <h1 className="mx-auto max-w-4xl font-display text-[3.6rem] font-black leading-[0.98] tracking-tight text-[#f4ebfb] drop-shadow-[0_0_18px_rgba(255,255,255,.12)] md:text-[5.65rem]">
              <span className="block">Kaderin</span>
              <span className="block title-ember animate-occult-flicker">Karanlık Yüzü</span>
              <span className="block">Seni Bekliyor</span>
            </h1>

            <p className="mx-auto mt-8 max-w-[780px] text-[16px] leading-8 text-whisper md:text-[17px]">
            ...
            <div className="mt-7 text-[12px] uppercase tracking-[0.32em] text-white/32 animate-occult-flicker">fısıltılar yaklaşır · semboller belirir · kapılar aralanır</div>
      ...
      <section id="kategoriler" className="relative px-4 py-16 md:px-6">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <h2 className="font-display text-[2.2rem] font-bold text-[#f3ebfa] md:text-[3.3rem]">Karanlık kapılar</h2>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            <div key={no} className="occult-card p-7 text-center">
              ...
              <h3 className="mb-3 font-display text-[1.6rem] font-semibold text-[#f3ebfa]">{title}</h3>
          ...
          {trustBadges.map((item) => {
            ...
            return (
              <div key={item.title} className="occult-card p-5 text-center">
                ...
                <h3 className="font-display text-[1.05rem] font-semibold text-[#f3ebfa]">{item.title}</h3>
          ...
          {testimonials.map((item) => (
            <div key={item.name} className="occult-card p-6">
              <div className="mb-3 flex items-center justify-between">
                <span className="font-display text-xl font-semibold text-[#f4ebfb]">{item.name}</span>
      ...
      <section className="px-4 py-20 md:px-6">
        <div className="occult-panel mx-auto max-w-5xl p-10 text-center">
          ...
          <h2 className="font-display text-[2.35rem] font-black text-[#f4ebfb] md:text-[3.6rem]">Perdenin Ardındakini Görmeye Hazır mısın?</h2>
