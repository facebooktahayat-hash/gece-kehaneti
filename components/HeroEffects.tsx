export function HeroEffects() {
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden bg-[#020006]">
      ...
      <div className="absolute left-1/2 top-[36%] h-[640px] w-[660px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-poison/16 blur-[96px] animate-breathe-purple" />
      <div className="absolute left-1/2 top-[40%] h-[300px] w-[320px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-ember/13 blur-[60px] animate-breathe-purple" />

      <svg className="absolute left-1/2 top-[40%] h-[1120px] w-[1120px] animate-ring-clockwise opacity-[.96] drop-shadow-[0_0_24px_rgba(255,0,184,.16)]" viewBox="0 0 1000 1000" fill="none">
