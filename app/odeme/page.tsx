    ...
    <section className="px-4 py-16 md:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="occult-panel p-8 text-center md:p-12">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-mourning">Bu ilk sürümde ödeme ekranı hazırlandı. DePay kripto ödeme linkin geldiğinde aşağıdaki buton gerçek ödeme linkine bağlanacak.</p>
          <div className="occult-card mx-auto mt-8 max-w-xl p-6 text-left"><div className="flex items-center gap-3 text-bone"><ShieldCheck className="h-6 w-6 text-[#c9a6df]" /><span className="font-display font-semibold">Güvenli ödeme altyapısına uygun</span></div><p className="mt-3 text-sm leading-6 text-mourning">DePay ile USDT/USDC gibi kripto varlıklarla ödeme almak için Payment Link veya Button entegrasyonu eklenebilir.</p></div>
