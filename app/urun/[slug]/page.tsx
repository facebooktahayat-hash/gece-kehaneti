      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr]">
          ...
          <aside className="occult-panel h-fit p-7">
            <div className="text-sm text-white/45">Paket fiyatı</div>
            <div className="mt-2 font-display text-5xl font-black text-ember drop-shadow-[0_0_16px_rgba(255,0,184,.35)]">{item.price} TL</div>
            ...
            <p className="mt-5 text-xs leading-6 text-white/40">Fal hizmeti eğlence ve kişisel farkındalık amaçlıdır. Kesin sonuç, sağlık, hukuk veya yatırım danışmanlığı sunmaz.</p>
          </aside>
        </div>
      </div>
    </section>
